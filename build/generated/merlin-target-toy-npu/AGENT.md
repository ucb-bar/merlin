# AGENT.md — merlin-target-toy_npu

## Purpose

Generated Merlin target package for `toy_npu` (dialect + runtime adapter).
...
- Regenerate with `python -m merlin.targetgen.cli build --target-name toy_npu ...`. Hand-edits after review are expected.
