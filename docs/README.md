...
- ["Design: a target's kernel anatomy, and the slot that was missing"](design/target_kernel_anatomy.md) — `draft`, verified 2026-08-11 · owner: targetgen — see also: [lowering_pipeline](reference/lowering_pipeline.md), [target_agnostic_core](design/target_agnostic_core.md), [triton_frontend](design/triton_frontend.md)
- ["Design: drive the core to zero target-specific literals"](design/target_agnostic_core.md) — `draft`, verified 2026-08-11 · owner: targetgen — see also: [target_resolution](guides/target_resolution.md)
- ["Design: incremental target evolution — RVV + Saturn OPU as the driving delta"](design/incremental_target_evolution_opu.md) — `draft`, verified 2026-08-17 · owner: targetgen — see also: [beam_cca_architecture](design/beam_cca_architecture.md), [lowering_pipeline](reference/lowering_pipeline.md), [llvm_integration](guides/llvm_integration.md), [reproducibility](guides/reproducibility.md)
- ["Design: subsystem boundaries and the schemas between them"](design/parallel_workstreams.md) — `current`, verified 2026-08-23 · owner: core — see also: [architecture](reference/architecture.md), [kernel_mining](guides/kernel_mining.md), [dse](guides/dse.md), [targetgen](guides/targetgen.md)
...
- ["Design: the RTL-derived compiler tooling — what it extracts, how it is used, and its honest value"](design/rtl_derived_compiler_tooling.md) — `draft`, verified 2026-08-13 · owner: targetgen — see also: [target_agnostic_core](design/target_agnostic_core.md), [compiler_plane](design/compiler_plane.md), [dialect_test_bar](design/dialect_test_bar.md), [expert_gap_attribution](design/expert_gap_attribution.md)
...
- ["Design: which OPU facts come from the ISA, and which only from measurement"](design/opu_fact_provenance.md) — `draft`, verified 2026-08-17 · owner: targetgen — see also: [incremental_target_evolution_opu](design/incremental_target_evolution_opu.md), [reproducibility](guides/reproducibility.md)
