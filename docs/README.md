...
- ["Design: incremental target evolution — RVV + Saturn OPU as the driving delta"](design/incremental_target_evolution_opu.md) — `draft`, verified 2026-08-15 · owner: targetgen — see also: [beam_cca_architecture](design/beam_cca_architecture.md), [lowering_pipeline](reference/lowering_pipeline.md), [llvm_integration](guides/llvm_integration.md), [reproducibility](guides/reproducibility.md)
