...
- **runtime** — [LLVM integration](guides/llvm_integration.md), [Runtime](reference/runtime.md), [RVV end-to-end — lower a model through model2MLIR and run it on the Merlin runtime](guides/rvv_e2e.md), [TinyLlama int8 on multicore RVV under Zephyr — end to end](guides/tinyllama_int8_rvv_zephyr.md), [Zephyr runtime backend](guides/zephyr.md)
