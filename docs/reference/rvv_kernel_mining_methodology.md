...
code_refs: [src/merlin/rvvgen, src/merlin/kernels]
---
...
- **Phase 1 agent authoring** is a separate experiment-owned system. It is **not** part of
...
| Phase 1 agent authoring | `merlin_experiments/phase1/providers/` |
...
(Phase 1 agent authoring is separate from the RVV beam; both retain the "nothing trusted until it
certifies" gate philosophy.)
