...
- **`src/merlin/runtime/`** — the target-independent Python plane: the command-buffer model
...
Concrete backends live under `src/merlin/runtime/backends/` and are addressed by **target
