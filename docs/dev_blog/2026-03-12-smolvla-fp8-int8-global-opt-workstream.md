...
> **Repro pin:** merlin@[`cf8c3ac1`](https://github.com/ucb-bar/merlin/commit/cf8c3ac1061b1db4cf3878725f7ff4007ad94183) · iree_bar@[`68acd99c74`](https://github.com/ucb-bar/iree_bar/commit/68acd99c74)
> **Status:** Active

## At a glance

This entry covers three distinct workstreams in the order the underlying work
landed. Jump to whichever you need:

- **§0–§13 — SmolVLA compilation & precision** (export, global-opt, FP8/INT8,
  NPU/Gemmini matching). Original 2026-03-12 → 2026-03-13 work.
- **§14–§16 — AutoComp kernel library, tile loops, cross-invocation
  orchestration**. 2026-04-11 → 2026-04-13 follow-up.
- **§17 — Golden-data testing ladder**. 2026-04-13 (later) infrastructure work.

Related entries:

- [2026-04-06 OPU VOPACC coverage](2026-04-06-opu-utilization-e2e-benchmarking.md) — narrow-M matmul findings cross-cut this work.

---

## 0. SmolVLA-specific Bootstrap (Verified 2026-03-13)

This section adds the SmolVLA-specific repos and exports on top of the generic
Merlin bootstrap. For the generic conda env / submodule sync / host build
steps, follow [getting_started.md](../getting_started.md) first.
...
./merlin build --profile npu --config release \
  --no-build-python-bindings --no-enable-libbacktrace
```
