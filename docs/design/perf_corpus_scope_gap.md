...
`experiments/templates/phase0/performance.yaml` is a `sweep` carrying `fit_axes`,
...
produced by `validate_composed_bands.py`, module `src/merlin/perf/compose_estimate.py`.
