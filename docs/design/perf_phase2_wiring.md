...
code_refs:
  ...
  - packages/merlin-experiments/src/merlin_experiments/phase2/functional_coverage.py
  - merlin/experiments/gemmini_perf_bench/scripts/perf_model.py
  - packages/merlin-experiments/src/merlin_experiments/phase2/holdout_corpus.py
  ...
  - src/merlin/perf/handshake.py
  - src/merlin/perf/global_planner.py
  - src/merlin/perf/agent_guidance.py
  - src/merlin/perf/artifact_activity.py
  - src/merlin/perf/command_buffer_diagnostics.py
  - src/merlin/perf/execution_policy.py
  - src/merlin/perf/model_placement.py
  - src/merlin/perf/movement_balance.py
  - src/merlin/perf/phase2_portfolio.py
  - src/merlin/perf/phase2_analytical_provider.py
  - src/merlin/perf/whole_model_report.py
  - src/merlin/perf/phase2_portfolio.py
  - src/merlin/xdsl_dialects/lowering/global_plan.py
  - src/merlin/xdsl_dialects/lowering/global_plan_emission.py
...
Those historical observations do not qualify the refactored implementation. Current ownership
and installed-workflow boundaries are described in [repository structure](../reference/repo_structure.md).
...
`src/merlin/perf/handshake.py` now walks the path instead of matching a name: a stage is a
...
An operator may explicitly request `merlin_experiments.phase2.functional_coverage`'s stratified policy. It groups the
