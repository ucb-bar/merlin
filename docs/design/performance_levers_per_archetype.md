...
code_refs: [src/merlin/perf/occupancy.py, src/merlin/perf/differential.py, src/merlin/targetgen/rtl/fsm.py, src/merlin/perf/depgraph.py, src/merlin/perf/deps/measured.py]
---
