...
code_refs: [src/merlin/kernels/microkernel.py, src/merlin/mining/from_strategy.py, src/merlin/llvmlower/impr_features.py, src/merlin/kernels/decode/rvv.py, src/merlin/mining/k1.py, build_tools/scripts/k1_microkernel_ipc_sweep.py]
---
