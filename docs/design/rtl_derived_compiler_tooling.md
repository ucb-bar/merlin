...
related: [compiler_plane, dialect_test_bar, expert_gap_attribution, capsule_bench]
code_refs:
  - src/merlin/targetgen/rtl/facts.py
  - src/merlin/targetgen/rtl/circt_introspect.py
  - src/merlin/targetgen/rtl/gen_isa_module.py
  - src/merlin/targetgen/rtl/gen_rtl_digest.py
  - src/merlin/targetgen/rtl/gen_numeric_facts.py
  - src/merlin/targetgen/rtl_backend.py
  - src/merlin/targetgen/rtl_check_compiler.py
  - src/merlin/targetgen/rtl_check_runner.py
