...
code_refs: [src/merlin/llvmlower/op_profile.py, merlin/runtime/c/merlin_op_prof.c, src/merlin/mining/k1.py, build_tools/scripts/k1_op_profile.py, packages/merlin-analysis/src/merlin/baselines/contract.py]
---
