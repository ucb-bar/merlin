...
code_refs: [build_tools/scripts/k1_codegen_vs_handc.py, merlin/python/merlin/mining/k1.py, merlin/python/merlin/llvmlower/impr_features.py, merlin/python/merlin/runtime/backends/ours_board/ours_gemm_rvv_shim.c]
---
