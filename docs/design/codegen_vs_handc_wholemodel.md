...
code_refs: [build_tools/scripts/k1_codegen_vs_handc.py, src/merlin/mining/k1.py, src/merlin/llvmlower/impr_features.py, src/merlin/runtime/backends/ours_board/ours_gemm_rvv_shim.c]
---
