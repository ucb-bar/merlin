...
code_refs: [src/merlin/perf/workload_gen.py, src/merlin/targetgen/contract/interface_emit.py, src/merlin/perf/falsifier.py, experiments/templates/phase0/performance.yaml]
---
...
`src/merlin/perf/command_stream_gen.py` — consuming the parsed command list from
