...
related: [lowering_pipeline, target_onboarding, triton_frontend]
code_refs:
  - src/merlin/runtime/backends/base.py
  - examples/muon/target/README.md
  - build_tools/upstreams/target_support.json
