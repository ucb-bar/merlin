...
code_refs: [src/merlin/kernels/escape_audit.py, packages/merlin-mining/src/merlin/mining/escape_sweep.py, src/merlin/llvmlower/selfcopy.py, src/merlin/kernels/cca.py, build_tools/scripts/k1_escape_cost.py]
---
