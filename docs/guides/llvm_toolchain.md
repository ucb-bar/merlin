...
code_refs: [src/merlin/llvmlower/toolchain.py, src/merlin/llvmlower/pipeline.py,
            src/merlin/targetgen/contract/toolchain.py, src/merlin/runtime/backends/zephyr_model.py]
---
