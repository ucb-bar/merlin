...
code_refs: [src/merlin/runtime/backends/spike_model.py, src/merlin/llvmlower/device_build.py, src/merlin/targetgen/oot_runner.py, src/merlin/targetgen/publish.py]
---
