...
Invokes ``claude -p ... --output-format json`` with a cache-buster nonce, captures
the transcript, and returns the final text. This DSE-specific transport is kept
independent of Phase 1 agent execution. Local auth, no API key.
