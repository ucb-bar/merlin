...
from merlin_experiments.phase1.providers import agent_bridge as _BR  # noqa: E402 - preserve env observation order
...
def run_round(
    ...
    **_ignored,
    ...
    if sandbox == "bwrap" and sandbox_command is None:
    ...
    if sandbox == "bwrap":
        ...
        cmd = [
            "bash",
            "-c",
            sandbox_command(inner, ws, bundle, extra_binds=opencode_runtime_binds(data_home, Path(cfgf.name))),
        ]
    else:
        cmd = run_cmd
