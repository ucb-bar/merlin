#!/usr/bin/env python3
"""Replay the exact model-derived add capsule on the Radiance L2 Cyclotron oracle."""
...
CAPSULE = "SY_app_elementwise_add_f32_rank3_1x113x1_l2"
...
def main() -> int:
    ...
    receipt = {
        "schema": "radiance_application_elementwise_l2_v1",
        "case": args.case,
        "capsule": CAPSULE,
