...
| rb_pilot_rep_02 | raw_baseline | claude-opus-4-8 | FAIL[contract]: no manifest.yaml in package /path/to/merlin/experiments/gemmini_capsule_bench_v0/runs/raw_baseline/rb_pilot_rep_02/submission | 0/0 | 0/0 | spike+verilator(L0-L3) |
| rb_pilot_rep_03 | raw_baseline | claude-opus-4-8 | FAIL[contract]: no manifest.yaml in package /path/to/merlin/experiments/gemmini_capsule_bench_v0/runs/raw_baseline/rb_pilot_rep_03/submission | 0/0 | 0/0 | spike+verilator(L0-L3) |
