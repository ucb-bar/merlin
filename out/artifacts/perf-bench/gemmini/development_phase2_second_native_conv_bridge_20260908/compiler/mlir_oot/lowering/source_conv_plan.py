...
class Convolution:
    ...
    acc_scale: float = 1.0
    relu: bool = False
    compute_only_native: bool = False
    # The exact batch-one NCHW mechanism is retained only as an explicit diagnostic. FireSim
    # q545 measured it 5.11% slower than streamed im2col because trans_input_3120 exposes one
    # systolic row at batch=1. Production planning must leave this false.
    diagnostic_transposed_compute_only: bool = False
    native_performance_refusal: str | None = None
