...
class LoopConvWsOp(_GemminiOp):
    ...
    def verify_(self) -> None:
        # input, weights, narrow output, and an internal read-only zero bias used to overwrite
        # persistent accumulator rows on every warm/measured invocation.
        _pointer_arguments(self, 4)
        positive = (
