...
class Emitter:
    ...
    def emit_host_segment(self, ins: Instr) -> None:
        ...
        lowering.run_segment(
            ...
            getattr(segment, "residual_fusions", ()))
    ...
    def build(self) -> ModuleOp:
        ...
        for ins in self.instrs:
            ...
            task_index = ins.attrs.get("global_task_index")
            self.fb.scoped_attributes = ({
                "merlin.global_task": IntegerAttr(task_index, i64)
            } if task_index is not None else {})
