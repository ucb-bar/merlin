...
class Builder:
    ...
    def _op_conv2d(self, node) -> None:
        ...
        candidate = Convolution(
            ...
            bias=e.bias, acc_scale=e.acc_scale, relu="relu" in e.stages,
        )
        ...
        native_loop_conv, _reason = select_native_loop_conv(
            ...
            epilogue_stages=e.stages, bias=e.bias, bias_buffer=bias_buffer,
        ...
        if native_loop_conv:
            ...
            self.commands.append({
                ...
                "operands": {"ifm": ifm.name, "weight": weight_name, "dst": node.name,
                             **({"bias": e.bias} if e.bias else {})},
                "attributes": {
                    "kernel": kernel, "stride": stride, "padding": padding,
                    "dilation": dilation, "layout": "nhwc", "output_dtype": e.output_dtype,
                    "epilogue": e.stages, "acc_scale": e.acc_scale,
                },
            })
