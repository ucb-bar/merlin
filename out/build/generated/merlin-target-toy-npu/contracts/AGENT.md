# AGENT.md — merlin-target-toy_npu/contracts

## Purpose

The five synchronized plan artifacts (target_contract, dialect_plan, runtime_adapter_plan, zephyr_plan, llvm_extension_plan).
