...
def setup_parser(parser: argparse.ArgumentParser):
    parser.add_argument(
        "--target", choices=["host", "spacemit", "firesim"], default="host", help="Target platform (default: host)"
    )
    parser.add_argument(
        "--config",
    ...
    parser.add_argument("--with-plugin", action="store_true", help="Enable Merlin compiler plugin")
