...
module attributes {transform.with_named_sequence} {
  ...
  hal.executable.source private @kb_saturnopu_add_f32 attributes {
    objects = #hal.executable.objects<{
      #kb_target_llvm_cpu_spacemit_x60 = [
        #hal.executable.object<{path = "saturnopu_add_f32.3bf893a6d973aaf1.riscv64-none-elf.o"}>
      ]
    }>
  } {
  ...
  hal.executable.source private @kb_saturnopu_conv_2d_nchw_fchw_f32 attributes {
    objects = #hal.executable.objects<{
      #kb_target_llvm_cpu_spacemit_x60 = [
        #hal.executable.object<{path = "saturnopu_conv_2d_nchw_fchw_f32.a936b720cf0ab92e.riscv64-none-elf.o"}>
      ]
    }>
  } {
  ...
  hal.executable.source private @kb_saturnopu_pooling_nchw_max_f32 attributes {
    objects = #hal.executable.objects<{
      #kb_target_llvm_cpu_spacemit_x60 = [
        #hal.executable.object<{path = "saturnopu_pooling_nchw_max_f32.d41cf398b5e03351.riscv64-none-elf.o"}>
      ]
    }>
  } {
  ...
  hal.executable.source private @kb_saturnopu_bias_add_3d_f32 attributes {
    objects = #hal.executable.objects<{
      #kb_target_llvm_cpu_spacemit_x60 = [
        #hal.executable.object<{path = "saturnopu_bias_add_3d_f32.958f4c3399b99f64.riscv64-none-elf.o"}>
      ]
    }>
  } {
  ...
  hal.executable.source private @kb_saturnopu_matmul_f32 attributes {
    objects = #hal.executable.objects<{
      #kb_target_llvm_cpu_spacemit_x60 = [
        #hal.executable.object<{path = "saturnopu_matmul_f32.ecea282dbe1e5855.riscv64-none-elf.o"}>
      ]
    }>
  } {
  ...
  hal.executable.source private @kb_saturnopu_linear_f32 attributes {
    objects = #hal.executable.objects<{
      #kb_target_llvm_cpu_spacemit_x60 = [
        #hal.executable.object<{path = "saturnopu_linear_f32.9f1e722354a3a5b8.riscv64-none-elf.o"}>
      ]
    }>
  } {
