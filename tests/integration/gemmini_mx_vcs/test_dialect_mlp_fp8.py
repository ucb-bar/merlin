"""End-to-end mxGemmini FP8 test: ./merlin sim → VCS → diff vs golden."""
...
FIXTURE = HERE / "fixtures" / "mlp_3layer_fp8.mlir"
EXPECTED = HERE / "fixtures" / "expected_fp8.txt"


@pytest.mark.timeout(1800)
def test_mxgemmini_mlp_fp8(merlin_cli: str, repo_root: pathlib.Path) -> None:
