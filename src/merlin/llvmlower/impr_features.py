...
# schedule. It is an IR-level rewrite: `int8_contractions.rewrite_prepared_file` replaces selected int8
...
register(
    ImprFeature(
        ...
        description=(
            ...
            "the rewrite happens on the prepared IR (llvmlower/int8_contractions), which is why both hooks are "
