# merlin-compare — verify_4way

target=`k1` · metric=`wall` · reps=5 · commit=`e49426f2aa59`
...
| workload | baseline | ours_wholemodel | ours_wholemodel_vf | xnnpack | openblas |
|---|---|---|---|---|---|
| openvla | 5.8599s ±0.9% (cos 1.0000) | 1.1893s ±3.5% (cos 1.0000) | 1.0902s ±1.1% (cos 1.0000) | 0.6516s ±2.5% (cos 1.0000) | 0.6870s ±1.7% (cos 1.0000) |
| rdt2 | 73.8266s ±0.4% (cos 1.0000) | 30.7772s ±2.1% (cos 1.0000) | not_measured | 18.9800s ±0.2% (cos 1.0000) | 20.3163s ±0.8% (cos 1.0000) |
| bitvla | 2.5243s ±0.5% (cos 1.0000) | not_measured | not_measured | 0.1913s ±2.0% (cos 1.0000) | 0.1885s ±3.0% (cos 1.0000) |
| gemm:64 | 0.0128s | 0.0001s | 0.0001s | 0.0001s | 0.0001s |
| gemm:128 | not_measured | 0.0006s | 0.0006s | 0.0013s | 0.0008s |
...
| ours_wholemodel_vf | fused_fma | False | True | 32/1.0 | vf=0, vv=16 |
...
- measured: ours=1.1893s, expert=0.6516s, ratio(ours/expert)=1.83x
...
- note: ours trails xnnpack: 55% of expert speed (ratio 1.83x of expert wall).
...
- measured: ours=1.1893s, expert=0.6870s, ratio(ours/expert)=1.73x
...
- measured: ours=1.0902s, expert=0.6516s, ratio(ours/expert)=1.67x
- structural divergences (expert vs ours):
...
- note: ours trails xnnpack: 60% of expert speed (ratio 1.67x of expert wall).
- note: static CCA decode gives the RANKING of structural factors, not exact cycle fractions (no K1 perf counters).

### openvla: `ours_wholemodel_vf` vs `openblas` — ours 63% of expert

- measured: ours=1.0902s, expert=0.6870s, ratio(ours/expert)=1.59x
- structural divergences (expert vs ours):
