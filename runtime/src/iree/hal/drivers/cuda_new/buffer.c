...
typedef struct iree_hal_cuda_new_buffer_t {
	iree_hal_buffer_t base;
	iree_allocator_t host_allocator;
	iree_hal_cuda_new_buffer_type_t type;
	void *host_ptr;
	CUdeviceptr device_ptr;
	iree_hal_buffer_release_callback_t release_callback;
} iree_hal_cuda_new_buffer_t;

static const iree_hal_buffer_vtable_t iree_hal_cuda_new_buffer_vtable;

static iree_hal_cuda_new_buffer_t *iree_hal_cuda_new_buffer_cast(
	iree_hal_buffer_t *base_value) {
	IREE_HAL_ASSERT_TYPE(base_value, &iree_hal_cuda_new_buffer_vtable);
	return (iree_hal_cuda_new_buffer_t *)base_value;
}

static const iree_hal_cuda_new_buffer_t *iree_hal_cuda_new_buffer_const_cast(
	const iree_hal_buffer_t *base_value) {
	IREE_HAL_ASSERT_TYPE(base_value, &iree_hal_cuda_new_buffer_vtable);
	return (const iree_hal_cuda_new_buffer_t *)base_value;
}
...
iree_status_t iree_hal_cuda_new_buffer_wrap(
	...
	iree_hal_cuda_new_buffer_t *buffer = NULL;
	...
	if (iree_status_is_ok(status)) {
		iree_hal_buffer_initialize(placement, &buffer->base, allocation_size,
			...
			&iree_hal_cuda_new_buffer_vtable, &buffer->base);
...
static void iree_hal_cuda_new_buffer_destroy(iree_hal_buffer_t *base_buffer) {
...
static iree_status_t iree_hal_cuda_new_buffer_map_range(
...
static iree_status_t iree_hal_cuda_new_buffer_unmap_range(
	iree_hal_buffer_t *base_buffer, iree_device_size_t local_byte_offset,
	iree_device_size_t local_byte_length, iree_hal_buffer_mapping_t *mapping) {
	return iree_ok_status();
}

static iree_status_t iree_hal_cuda_new_buffer_invalidate_range(
	iree_hal_buffer_t *base_buffer, iree_device_size_t local_byte_offset,
	iree_device_size_t local_byte_length) {
	return iree_ok_status();
}

static iree_status_t iree_hal_cuda_new_buffer_flush_range(
	iree_hal_buffer_t *base_buffer, iree_device_size_t local_byte_offset,
	iree_device_size_t local_byte_length) {
	return iree_ok_status();
}
...
iree_hal_cuda_new_buffer_type_t iree_hal_cuda_new_buffer_type(
	...
	const iree_hal_cuda_new_buffer_t *buffer =
		iree_hal_cuda_new_buffer_const_cast(base_buffer);
	return buffer->type;
}
...
void *iree_hal_cuda_new_buffer_host_pointer(
	const iree_hal_buffer_t *base_buffer) {
	const iree_hal_cuda_new_buffer_t *buffer =
		iree_hal_cuda_new_buffer_const_cast(base_buffer);
...
static const iree_hal_buffer_vtable_t iree_hal_cuda_new_buffer_vtable = {
	...
	.map_range = iree_hal_cuda_new_buffer_map_range,
	.unmap_range = iree_hal_cuda_new_buffer_unmap_range,
	.invalidate_range = iree_hal_cuda_new_buffer_invalidate_range,
	.flush_range = iree_hal_cuda_new_buffer_flush_range,
};
