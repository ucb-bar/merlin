...
#ifndef IREE_HAL_DRIVERS_CUDA_TILE_EVENT_POOL_H_
#define IREE_HAL_DRIVERS_CUDA_TILE_EVENT_POOL_H_
...
// management.
//
// iree_hal_cuda_tile_event_t objects cannot be directly created; they should be
...
typedef struct iree_hal_cuda_tile_event_t iree_hal_cuda_tile_event_t;
...
typedef struct iree_hal_cuda_tile_event_pool_t iree_hal_cuda_tile_event_pool_t;
...
#endif  // IREE_HAL_DRIVERS_CUDA_TILE_EVENT_POOL_H_
