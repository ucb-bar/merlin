...
#ifndef IREE_HAL_DRIVERS_CUDA_TILE_EVENT_SEMAPHORE_H_
#define IREE_HAL_DRIVERS_CUDA_TILE_EVENT_SEMAPHORE_H_
...
// Acquires an iree_hal_cuda_tile_event_t object to wait on the host for the
...
#endif  // IREE_HAL_DRIVERS_CUDA_TILE_EVENT_SEMAPHORE_H_
