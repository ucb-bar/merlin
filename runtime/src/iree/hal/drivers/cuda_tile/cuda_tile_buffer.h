...
#ifndef IREE_HAL_DRIVERS_CUDA_TILE_CUDA_BUFFER_H_
#define IREE_HAL_DRIVERS_CUDA_TILE_CUDA_BUFFER_H_
...
typedef enum iree_hal_cuda_tile_buffer_type_e {
  ...
  IREE_HAL_CUDA_TILE_BUFFER_TYPE_EXTERNAL,
} iree_hal_cuda_tile_buffer_type_t;
...
void* iree_hal_cuda_tile_buffer_host_pointer(const iree_hal_buffer_t* buffer);
...
void iree_hal_cuda_tile_buffer_drop_release_callback(iree_hal_buffer_t* buffer);

#ifdef __cplusplus
}  // extern "C"
#endif  // __cplusplus

#endif  // IREE_HAL_DRIVERS_CUDA_TILE_CUDA_BUFFER_H_
