...
#ifndef IREE_HAL_DRIVERS_CUDA_TILE_NCCL_DYNAMIC_SYMBOLS_H_
#define IREE_HAL_DRIVERS_CUDA_TILE_NCCL_DYNAMIC_SYMBOLS_H_

#include "iree/base/api.h"
#include "iree/base/internal/dynamic_library.h"
#include "iree/hal/drivers/cuda_tile/cuda_tile_dynamic_symbols.h"
#include "iree/hal/drivers/cuda_tile/cuda_tile_nccl_headers.h"
...
typedef struct iree_hal_cuda_tile_nccl_dynamic_symbols_t {
...
#include "iree/hal/drivers/cuda_tile/cuda_tile_nccl_dynamic_symbol_table.h"  // IWYU pragma: export
#undef IREE_NCCL_PFN_DECL
#undef IREE_NCCL_PFN_DECL_STR_RETURN
} iree_hal_cuda_tile_nccl_dynamic_symbols_t;

// Initializes |out_syms| in-place with dynamically loaded NCCL symbols.
// iree_hal_cuda_tile_dynamic_symbols_deinitialize must be used to release the
// library resources.
...
#endif  // IREE_HAL_DRIVERS_CUDA_TILE_NCCL_DYNAMIC_SYMBOLS_H_
