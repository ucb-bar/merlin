...
#ifndef IREE_HAL_DRIVERS_CUDA_TILE_CUDA_STATUS_UTIL_H_
#define IREE_HAL_DRIVERS_CUDA_TILE_CUDA_STATUS_UTIL_H_
...
#define IREE_CURESULT_TO_STATUS(syms, expr, ...) \
  iree_hal_cuda_tile_result_to_status((syms), ((syms)->expr), __FILE__, __LINE__)
...
#define IREE_CUDA_RETURN_IF_ERROR(syms, expr, ...)                            \
  IREE_RETURN_IF_ERROR(iree_hal_cuda_tile_result_to_status((syms), ((syms)->expr), \
                                                      __FILE__, __LINE__),    \
                       __VA_ARGS__)
...
#define IREE_CUDA_RETURN_AND_END_ZONE_IF_ERROR(zone_id, syms, expr, ...) \
  IREE_RETURN_AND_END_ZONE_IF_ERROR(                                     \
      zone_id,                                                           \
      iree_hal_cuda_tile_result_to_status((syms), ((syms)->expr), __FILE__,   \
                                     __LINE__),                          \
      __VA_ARGS__)
...
#define IREE_CUDA_IGNORE_ERROR(syms, expr)                                 \
  IREE_IGNORE_ERROR(iree_hal_cuda_tile_result_to_status((syms), ((syms)->expr), \
                                                   __FILE__, __LINE__))

// cuda_tile-prefixed aliases for use in cuda_tile driver code.
#define IREE_CUDA_TILE_RETURN_IF_ERROR IREE_CUDA_RETURN_IF_ERROR
#define IREE_CUDA_TILE_RETURN_AND_END_ZONE_IF_ERROR \
  IREE_CUDA_RETURN_AND_END_ZONE_IF_ERROR
#define IREE_CUDA_TILE_IGNORE_ERROR IREE_CUDA_IGNORE_ERROR

// Converts a CUresult to an iree_status_t object.
iree_status_t iree_hal_cuda_tile_result_to_status(
    const iree_hal_cuda_tile_dynamic_symbols_t* syms, CUresult result,
...
#endif  // IREE_HAL_DRIVERS_CUDA_TILE_CUDA_STATUS_UTIL_H_
