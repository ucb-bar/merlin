...
#ifndef IREE_HAL_DRIVERS_CUDA_TILE_NCCL_CHANNEL_H_
#define IREE_HAL_DRIVERS_CUDA_TILE_NCCL_CHANNEL_H_
...
static inline bool iree_hal_cuda_tile_nccl_id_is_empty(
...
#endif  // IREE_HAL_DRIVERS_CUDA_TILE_NCCL_CHANNEL_H_
