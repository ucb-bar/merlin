...
#ifndef IREE_HAL_DRIVERS_CUDA_TILE_CUDA_DYNAMIC_SYMBOLS_H_
#define IREE_HAL_DRIVERS_CUDA_TILE_CUDA_DYNAMIC_SYMBOLS_H_
...
typedef struct iree_hal_cuda_tile_dynamic_symbols_t {
...
#include "iree/hal/drivers/cuda_tile/cuda_tile_dynamic_symbol_table.h"  // IWYU pragma: export
#undef IREE_CU_PFN_DECL
} iree_hal_cuda_tile_dynamic_symbols_t;
...
// library resources.
iree_status_t iree_hal_cuda_tile_dynamic_symbols_initialize(
    iree_allocator_t host_allocator, iree_hal_cuda_tile_dynamic_symbols_t* out_syms);
...
void iree_hal_cuda_tile_dynamic_symbols_deinitialize(
    iree_hal_cuda_tile_dynamic_symbols_t* syms);

#ifdef __cplusplus
}  // extern "C"
#endif  // __cplusplus

#endif  // IREE_HAL_DRIVERS_CUDA_TILE_CUDA_DYNAMIC_SYMBOLS_H_
