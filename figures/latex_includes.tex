...
\begin{figure*}[t]
  ...
  These are best valid diagnostic walls, not a paired uniform certification set, and smolVLA is not
  measured at one core. The smolVLA eight-core triangle is an upper bound because Merlin did not
  complete within 120 s; its ExecuTorch reference is a seeded-random recomputation rather than
  Merlin's captured weights. ResNet-50 passes the diagnostic absolute W8A8 bar but lacks an
