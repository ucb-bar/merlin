...
results/gemmini/experiment_preflight_report.md ending in GO_FOR_PILOT or NO_GO.
"""
...
def main() -> int:
    ...
    L = ["# capsule_bench_v0 — experiment pre-flight report", "",
         ...
         "launched. Generated by `experiments/capsule_bench/targets/gemmini/scripts/preflight.py`.", "",
         "## Checklist", ""]
