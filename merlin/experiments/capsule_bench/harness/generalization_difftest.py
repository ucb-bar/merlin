...
def datapath_policy() -> dict:
    ...
    """
    from merlin.targetgen.capsule_runner import resolve_numeric_policy

    dp, _, experiment = resolve_numeric_policy(TARGET, descriptor=C.DESCRIPTOR)
    if not dp:
        raise ValueError("generalization probes require an explicitly declared numeric_profile")
    ...
    try:
        ...
        b = _CS.derive_binding(experiment, dp)
