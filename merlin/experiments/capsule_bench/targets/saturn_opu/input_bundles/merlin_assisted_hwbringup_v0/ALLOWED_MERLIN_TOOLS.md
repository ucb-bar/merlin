...
- `merlin/contract/capsules/saturn_opu/isa/` — capsule corpus
- `merlin/contract/capsules/saturn_opu/layers/` — declared by the generated bundle manifest
- `merlin/contract/capsules/saturn_opu/model_slices/` — declared by the generated bundle manifest
- `experiments/capsule_bench/targets/saturn_opu/task/` — declared by the generated bundle manifest
- `third_party/llvm-install/` — LLVM/MLIR 23 toolchain
- `experiments/capsule_bench/targets/saturn_opu/scripts/agent_selfcheck.py` — redacted self-check
...
- `merlin/targets/saturn_opu_mxv256d128/contracts/rtl_facts/` — RTL facts (CIRCT arm only)
...
- `merlin/contract/capsules/saturn_opu/hidden/` — hidden capsules + goldens
- `experiments/capsule_bench/targets/saturn_opu/input_bundles/grader_private_v0/` — grader-private
- `experiments/capsule_bench/targets/saturn_opu/runs/` — prior submissions
