...
- `experiments/capsule_bench/targets/gemmini_universal/contracts/isa_include/gemmini.h` — ISA header (shared hardware spec)
- `experiments/capsule_bench/targets/gemmini_universal/contracts/isa_include/gemmini_params.h` — ISA header (shared hardware spec)
- `experiments/capsule_bench/targets/gemmini_universal/task/` — declared by the generated bundle manifest
- `third_party/llvm-install/` — LLVM/MLIR 23 toolchain
- `experiments/capsule_bench/targets/gemmini_universal/contracts/hwbringup_gemmini_universal_v0` — shared hardware spec: RTL + ISA headers + README + example (ALL arms)
- `experiments/capsule_bench/targets/gemmini_universal/scripts/agent_selfcheck.py` — redacted self-check
...
- `merlin/targets/gemmini_universal/contracts/rtl_facts/` — RTL facts (CIRCT arm only)
...
- `experiments/capsule_bench/targets/gemmini_universal/input_bundles/grader_private_v0/` — grader-private
- `experiments/capsule_bench/targets/gemmini_universal/runs/` — prior submissions
