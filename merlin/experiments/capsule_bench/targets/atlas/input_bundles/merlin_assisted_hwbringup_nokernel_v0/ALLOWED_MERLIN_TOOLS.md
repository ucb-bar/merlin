...
- `merlin/contract/capsules/atlas/isa/` — capsule corpus
- `merlin/contract/capsules/atlas/layers/` — declared by the generated bundle manifest
- `merlin/contract/capsules/atlas/model/` — declared by the generated bundle manifest
- `merlin/contract/capsules/atlas/model_slices/` — declared by the generated bundle manifest
- `merlin/contract/capsules/atlas/perf/` — declared by the generated bundle manifest
- `experiments/capsule_bench/targets/atlas/contracts/hwbringup_atlas_v0/isa_include/atlas_isa_green_card.md` — ISA header (shared hardware spec)
- `experiments/capsule_bench/targets/atlas/contracts/hwbringup_atlas_v0/isa_include/isa_definition.py` — ISA header (shared hardware spec)
- `experiments/capsule_bench/targets/atlas/task/` — declared by the generated bundle manifest
- `third_party/llvm-install/` — LLVM/MLIR 23 toolchain
- `experiments/capsule_bench/targets/atlas/contracts/hwbringup_atlas_v0` — shared hardware spec: RTL + ISA headers + README + example (ALL arms)
- `experiments/capsule_bench/targets/atlas/scripts/agent_selfcheck.py` — redacted self-check
...
- `merlin/targets/atlas/contracts/rtl_facts/` — RTL facts (CIRCT arm only)
...
- `out/artifacts/targets/atlas/agent_spec_v1_mlir_oot/` — prior backend / exemplar (answer surface)
- `merlin/contract/capsules/atlas/hidden/` — hidden capsules + goldens
- `experiments/capsule_bench/targets/atlas/input_bundles/grader_private_v0/` — grader-private
- `experiments/capsule_bench/targets/atlas/runs/` — prior submissions
