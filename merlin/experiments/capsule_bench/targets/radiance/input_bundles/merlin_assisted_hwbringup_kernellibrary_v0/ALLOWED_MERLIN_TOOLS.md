# Allowed Merlin tooling — generated for `merlin_assisted_hwbringup_kernellibrary_v0`

This is the human-readable view of the **authoring** grants for arm `merlin_assisted`. It is generated from
...
- `merlin/contract/capsules/radiance/isa/` — capsule corpus
- `merlin/contract/capsules/radiance/layers/` — declared by the generated bundle manifest
- `merlin/contract/capsules/radiance/model/` — declared by the generated bundle manifest
- `merlin/contract/capsules/radiance/model_slices/` — declared by the generated bundle manifest
- `experiments/capsule_bench/targets/radiance/contracts/hwbringup_radiance_v0/isa_include/isa_definition.py` — ISA header (shared hardware spec)
- `experiments/capsule_bench/targets/radiance/task/` — declared by the generated bundle manifest
- `third_party/llvm-install/` — LLVM/MLIR 23 toolchain
- `experiments/capsule_bench/targets/radiance/contracts/hwbringup_radiance_v0` — shared hardware spec: RTL + ISA headers + README + example (ALL arms)
- `experiments/capsule_bench/targets/radiance/scripts/agent_selfcheck.py` — redacted self-check
- `out/artifacts/targets/rvv/rvv_tuned_v1_d1_vfmacc_outerproduct/` — frozen host lane (pinned infrastructure, read-only)
- `out/artifacts/targets/radiance/kernel_library_pr1_v1/` — exact pinned PR#1 kernel-library snapshot for schedule and compiler-rule mining
...
- `merlin/targets/muon/contracts/rtl_facts/` — RTL facts (CIRCT arm only)
...
- `out/artifacts/targets/radiance/hand_v0/` — prior backend / exemplar (answer surface)
- `out/artifacts/targets/radiance/radiance_mlir/` — prior backend / exemplar (answer surface)
- `merlin/contract/capsules/radiance/hidden/` — hidden capsules + goldens
- `experiments/capsule_bench/targets/radiance/input_bundles/grader_private_v0/` — grader-private
- `experiments/capsule_bench/targets/radiance/runs/` — prior submissions
