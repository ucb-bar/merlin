...
You are bringing up a C++ out-of-tree MLIR backend for an accelerator from its RTL + ISA headers + one
example kernel. Before writing code, commit to this plan (it is target-agnostic — it tells you *method*,
not the answer):
