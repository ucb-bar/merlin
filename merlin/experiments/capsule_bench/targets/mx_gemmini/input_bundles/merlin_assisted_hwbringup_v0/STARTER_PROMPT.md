...
- `cca_contract.check_bijection("mx_gemmini")` — the *what-to-build* checklist: which lever axes this
...
- `action_catalog.escalation_ladder(axis, "mx_gemmini")` — for one axis, the full
