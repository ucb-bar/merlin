...
- `merlin/contract/capsules/mx_gemmini/isa/` — capsule corpus
- `merlin/contract/capsules/mx_gemmini/layers/` — declared by the generated bundle manifest
- `merlin/contract/capsules/mx_gemmini/model/` — declared by the generated bundle manifest
- `merlin/contract/capsules/mx_gemmini/model_slices/` — declared by the generated bundle manifest
- `experiments/capsule_bench/targets/mx_gemmini/contracts/hwbringup_mx_v0/isa_include/isa_definition.py` — ISA header (shared hardware spec)
- `experiments/capsule_bench/targets/mx_gemmini/task/` — declared by the generated bundle manifest
- `third_party/llvm-install/` — LLVM/MLIR 23 toolchain
- `experiments/capsule_bench/targets/mx_gemmini/contracts/hwbringup_mx_v0` — shared hardware spec: RTL + ISA headers + README + example (ALL arms)
- `experiments/capsule_bench/targets/mx_gemmini/scripts/agent_selfcheck.py` — redacted self-check
...
- `merlin/targets/mx_gemmini/contracts/rtl_facts/` — RTL facts (CIRCT arm only)
...
- `merlin/contract/capsules/mx_gemmini/hidden/` — hidden capsules + goldens
- `experiments/capsule_bench/targets/mx_gemmini/input_bundles/grader_private_v0/` — grader-private
- `experiments/capsule_bench/targets/mx_gemmini/runs/` — prior submissions
