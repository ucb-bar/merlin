// G07_relu_i8_64x64x64 (requant+relu->i8)
module attributes {merlin_iface.version = "0.1", merlin_iface.target = "gemmini", merlin_iface.abi_version = "0.1"} {
  ...
  %Y0 = merlin_iface.commit %acc0 {name = "Y0", epilogue = ["acc_scale", "relu"], output_dtype = "i8", acc_scale = 0.0625 : f32} : (!merlin_iface.acc<i32>) -> tensor<64x64xi8>
