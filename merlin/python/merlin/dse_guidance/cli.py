...
def _insight_mining(args) -> int:
    ...
    cs_dir = (
        Path(args.case_study_dir) if args.case_study_dir else (paths.artifacts_dir() / "dse-guidance" / "case_study")
    )
...
def _query(args) -> int:
    ...
    base = Path(args.out) if args.out else (paths.artifacts_dir() / "dse-guidance" / "case_study")
...
def main(argv: list[str] | None = None) -> int:
    ...
    ap.add_argument(
        "--case-study-dir", default=None, help="case-study artifact dir to mine (default: committed case_study)"
    )
    ap.add_argument(
        "--query",
        default=None,
