...
def command_graph(topo, attribution) -> dict:
    ...
    return {
        ...
        "dependency_graph": {"value": None, "evidence": E_NA, "note": "per-step dependencies erased by loop unrolling"},
        "allocations_in_loop": {
            "value": None,
            "evidence": E_NA,
