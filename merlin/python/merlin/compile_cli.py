...
from .compile.bundles import (  # noqa: F401 -- re-exported
    _IR_ELEMENT_ORDER, _IR_ELEMENT_SPELLING, _bundle_dir, _capture_python, ir_scalar_dtype,
)
from .compile.host_lane import (  # noqa: F401 -- re-exported
    _DTYPE_STRATEGY, _verified_against_the_pinned_lane, default_package, host_lane_identity,
    host_lane_pin_name,
)
from .compile.capacity import (  # noqa: F401 -- re-exported
    _accumulator_capacity_elems, _capacity_fit_tile, _dtype_bits, _dtype_bytes, _operand_store_bytes,
    _operand_store_capacity_elems, capacity_fit, declared_primitive_tile,
)
from .compile.mesh_backend import (  # noqa: F401 -- re-exported
    _MESH_PKG_CACHE, _MESH_PKG_LOCK, _MESH_REFUSAL, _MESH_RUN_SEQ, _built_mesh_package, _mesh_invocation_id,
    _mesh_layer_id, _refuse, _requested_mesh_simulator, _resolve_oot_mesh_simulator,
)
from .compile.mesh_reference import (  # noqa: F401 -- re-exported
    _accum_rel_tolerance, _reference_on_datapath,
)
from .compile.mesh import (  # noqa: F401 -- re-exported
    _MESH_NTILE_WIDTH, _certify_tile_via_executor, _default_oot_package, _matmul_via_bespoke_sim,
    _matmul_via_oot_cert, _matmul_via_program_oracle, _mesh_rows, _mesh_tile_binding, _mesh_verify,
    run_matmul_on_mesh,
)
from .compile.mesh_model import (  # noqa: F401 -- re-exported
    _int8_chain_reference, run_int8_chain_on_mesh, run_whole_model_on_mesh,
)
...
def compile_rvv(workload: str, dtype: str, *, run: str, verify: bool, package: str | None,
    ...
    if bundle_path is not None and capture_bundle is not None:
        raise ValueError("pass either bundle_path or capture_bundle, never both: they pin the same "
