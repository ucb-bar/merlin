"""Prototype merlin.interface dialect (xDSL).
...
DIALECT_NAME = "merlin.interface"

# TODO: define ops/types using xdsl.irdl once xdsl is installed
# (pip install -e '.[xdsl]'). Keep names aligned with
# merlin/compiler/include/merlin/Dialect/Interface/ so stable promotion is mechanical.
