...
module attributes {merlin_iface.version = "0.1", merlin_iface.target = "gemmini", merlin_iface.abi_version = "0.1"} {
  ...
  %Y0 = merlin_iface.conv2d %IFM, %W_res {kernel = [3, 3, 4, 16], stride = [1, 1], padding = [0, 0, 0, 0], dilation = [1, 1], name = "Y0", epilogue = ["maxpool"], output_dtype = "i32", layout = "nhwc", pool_in_dims = [6, 6], pool_size = [2, 2], pool_stride = [2, 2], pool_padding = [0, 0, 0, 0]} : (tensor<1x8x8x4xi8>, !merlin_iface.resident) -> tensor<9x16xi32>
