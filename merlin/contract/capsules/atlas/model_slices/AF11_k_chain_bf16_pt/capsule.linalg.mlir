builtin.module attributes {prov.level = "linalg-on-tensors"} {
  func.func @forward(%0: tensor<16x16xbf16>, %1: tensor<16x16xbf16>, %2: tensor<16x16xbf16>) -> tensor<16x16xbf16> {
    ...
    %9 = linalg.fill {prov.op = "fill", prov.family = "fill"} ins(%8 : bf16) outs(%7 : tensor<16x16xbf16>) -> tensor<16x16xbf16>
    %10 = linalg.matmul {prov.region_id = "matmul_1", prov.op = "matmul", prov.family = "contraction", prov.aten = "aten.mm.default", prov.orig_dtype = "bfloat16"} ins(%6, %2 : tensor<16x16xbf16>, tensor<16x16xbf16>) outs(%9 : tensor<16x16xbf16>) -> tensor<16x16xbf16>
    func.return %10 : tensor<16x16xbf16>
  }
}
