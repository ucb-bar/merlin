"""Auto-generated capsule loader (attention_scaled, bf16). Defines the op in PyTorch; model2MLIR
...
class Model(nn.Module):
    def forward(self, q, k, v, s):
        return ((q @ k) * s).softmax(-1) @ v
def get_model_and_inputs():
    return Model(), (_r(32, 32), _r(32, 32), _r(32, 32), _r(32, 32))
