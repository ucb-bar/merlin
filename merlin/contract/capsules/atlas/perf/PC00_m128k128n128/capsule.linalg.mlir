builtin.module attributes {prov.level = "linalg-on-tensors"} {
  func.func @forward(%0: tensor<128x128xbf16>, %1: tensor<128x128xbf16>, %2: tensor<128x128xbf16>) -> tensor<128x128xbf16> {
    ...
    %6 = linalg.matmul {prov.region_id = "matmul_0", prov.op = "matmul", prov.family = "contraction", prov.aten = "aten.mm.default", prov.orig_dtype = "bfloat16"} ins(%0, %1 : tensor<128x128xbf16>, tensor<128x128xbf16>) outs(%5 : tensor<128x128xbf16>) -> tensor<128x128xbf16>
