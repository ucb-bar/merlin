module attributes {merlin_iface.version = "0.1", merlin_iface.target = "gemmini", merlin_iface.abi_version = "0.1"} {
  ...
  %Y0 = merlin_iface.commit %acc0 {name = "Y0", epilogue = ["maxpool"], output_dtype = "i8", pool_in_dims = [4, 4], pool_size = [2, 2], pool_stride = [2, 2], pool_padding = [0, 0, 0, 0]} : (!merlin_iface.acc<i32>) -> tensor<4x16xi8>
