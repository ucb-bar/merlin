builtin.module attributes {prov.level = "linalg-on-tensors"} {
  func.func @forward(%0: tensor<16x32xf32>, %1: tensor<15x32xf32>, %2: tensor<15x32xf32>) -> tensor<16x32xf32> {
    %3 = tensor.empty() : tensor<32x15xf32>
    %4 = linalg.transpose ins(%1:tensor<15x32xf32>) outs(%3:tensor<32x15xf32>) permutation = [1, 0]
    ...
    %8 = linalg.matmul {prov.region_id = "matmul_0", prov.op = "matmul", prov.family = "contraction", prov.aten = "aten.mm.default", prov.orig_dtype = "float32", prov.transposed_b = "true"} ins(%0, %4 : tensor<16x32xf32>, tensor<32x15xf32>) outs(%7 : tensor<16x15xf32>) -> tensor<16x15xf32>
    ...
    %51 = linalg.matmul {prov.region_id = "matmul_1", prov.op = "matmul", prov.family = "contraction", prov.aten = "aten.mm.default", prov.orig_dtype = "float32"} ins(%43, %2 : tensor<16x15xf32>, tensor<15x32xf32>) outs(%50 : tensor<16x32xf32>) -> tensor<16x32xf32>
