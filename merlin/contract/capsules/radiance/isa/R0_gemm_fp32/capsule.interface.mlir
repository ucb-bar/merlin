module attributes {merlin_iface.version = "0.1", merlin_iface.target = "radiance", merlin_iface.abi_version = "0.1"} {
  ...
  %A0 = merlin_iface.tensor {name = "A0", role = "input"} : tensor<16x16xf32>
  %W_res = merlin_iface.resident_pack %W {layout = "packed_rhs"} : (tensor<16x16xf32>) -> !merlin_iface.resident
  %acc0 = merlin_iface.matmul %A0, %W_res : (tensor<16x16xf32>, !merlin_iface.resident) -> !merlin_iface.acc<f32>
