builtin.module attributes {prov.level = "linalg-on-tensors"} {
  func.func @forward(%0: tensor<16x32xf16>, %1: tensor<15x32xf16>, %2: tensor<15x32xf16>) -> tensor<16x32xf16> {
    %3 = tensor.empty() : tensor<32x15xf16>
    %4 = linalg.transpose ins(%1:tensor<15x32xf16>) outs(%3:tensor<32x15xf16>) permutation = [1, 0]
    ...
    %8 = linalg.matmul {prov.region_id = "matmul_0", prov.op = "matmul", prov.family = "contraction", prov.aten = "aten.mm.default", prov.orig_dtype = "float16", prov.transposed_b = "true"} ins(%0, %4 : tensor<16x32xf16>, tensor<32x15xf16>) outs(%7 : tensor<16x15xf16>) -> tensor<16x15xf16>
    ...
    %51 = linalg.matmul {prov.region_id = "matmul_1", prov.op = "matmul", prov.family = "contraction", prov.aten = "aten.mm.default", prov.orig_dtype = "float16"} ins(%43, %2 : tensor<16x15xf16>, tensor<15x32xf16>) outs(%50 : tensor<16x32xf16>) -> tensor<16x32xf16>
