"""Auto-generated capsule loader (attention_full, fp16). Defines the op in PyTorch; model2MLIR
...
class Model(nn.Module):
    def forward(self, q, k, v):
        s = (q @ k.transpose(-2, -1)) / math.sqrt(64)
        if True:
            t = q.shape[-2]
...
def get_model_and_inputs():
    return Model(), (_r(16, 64), _r(16, 64), _r(16, 64))
