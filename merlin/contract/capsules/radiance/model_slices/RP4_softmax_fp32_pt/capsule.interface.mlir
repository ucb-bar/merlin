builtin.module attributes {prov.weights_file = "/tmp/capsule_m2m_eb64avvm/weights.safetensors", prov.level = "linalg-on-tensors"} {
  func.func @forward(%0: tensor<16x16xf32>) -> tensor<16x16xf32> {
    ...
    %3 = linalg.reduce ins(%0:tensor<16x16xf32>) outs(%2:tensor<16xf32>) dimensions = [1]
    (%4: f32, %5: f32) {
    ...
    %21 = linalg.reduce ins(%15:tensor<16x16xf32>) outs(%20:tensor<16xf32>) dimensions = [1]
    (%22: f32, %23: f32) {
