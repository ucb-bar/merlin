builtin.module attributes {prov.level = "linalg-on-tensors"} {
  func.func @forward(%0: tensor<16x32xbf16>, %1: tensor<16x32xbf16>, %2: tensor<16x32xbf16>) -> tensor<16x32xbf16> {
    %3 = tensor.empty() : tensor<32x16xbf16>
    %4 = linalg.transpose ins(%1:tensor<16x32xbf16>) outs(%3:tensor<32x16xbf16>) permutation = [1, 0]
    ...
    %8 = linalg.matmul {prov.region_id = "matmul_0", prov.op = "matmul", prov.family = "contraction", prov.aten = "aten.mm.default", prov.orig_dtype = "bfloat16", prov.transposed_b = "true"} ins(%0, %4 : tensor<16x32xbf16>, tensor<32x16xbf16>) outs(%7 : tensor<16x16xbf16>) -> tensor<16x16xbf16>
    %9 = arith.constant {prov.region_id = "div_0", prov._pattern_hint = "div", prov.op = "div", prov.family = "elementwise", prov.aten = "aten.div.Tensor", prov.orig_dtype = "bfloat16"} 5.656250e+00 : bf16
    ...
    %19 = linalg.reduce ins(%12:tensor<16x16xbf16>) outs(%18:tensor<16xbf16>) dimensions = [1]
    (%20: bf16, %21: bf16) {
    ...
    %24 = tensor.empty() : tensor<16x16xbf16>
    %25 = linalg.generic {indexing_maps = [affine_map<(d0, d1) -> (d0, d1)>, affine_map<(d0, d1) -> (d0, 0)>, affine_map<(d0, d1) -> (d0, d1)>], iterator_types = ["parallel", "parallel"]} ins(%12, %23 : tensor<16x16xbf16>, tensor<16x1xbf16>) outs(%24 : tensor<16x16xbf16>) attrs =  {prov.region_id = "softmax_0", prov.family = "normalization", prov._pattern_hint = "softmax", prov.op = "softmax", prov.aten = "aten._softmax.default", prov.orig_dtype = "bfloat16"} {
    ^bb1(%26: bf16, %27: bf16, %28: bf16):
      %29 = arith.subf %26, %27 : bf16
      linalg.yield %29 : bf16
    } -> tensor<16x16xbf16>
    %30 = tensor.empty() : tensor<16x16xbf16>
    %31 = linalg.generic {indexing_maps = [affine_map<(d0, d1) -> (d0, d1)>, affine_map<(d0, d1) -> (d0, d1)>], iterator_types = ["parallel", "parallel"]} ins(%25 : tensor<16x16xbf16>) outs(%30 : tensor<16x16xbf16>) attrs =  {prov.region_id = "softmax_0", prov.family = "normalization", prov._pattern_hint = "softmax", prov.op = "softmax", prov.aten = "aten._softmax.default", prov.orig_dtype = "bfloat16"} {
    ^bb2(%32: bf16, %33: bf16):
      %34 = math.exp %32 : bf16
    ...
    %37 = linalg.reduce ins(%31:tensor<16x16xbf16>) outs(%36:tensor<16xbf16>) dimensions = [1]
    (%38: bf16, %39: bf16) {
    ...
    %43 = linalg.generic {indexing_maps = [affine_map<(d0, d1) -> (d0, d1)>, affine_map<(d0, d1) -> (d0, 0)>, affine_map<(d0, d1) -> (d0, d1)>], iterator_types = ["parallel", "parallel"]} ins(%31, %41 : tensor<16x16xbf16>, tensor<16x1xbf16>) outs(%42 : tensor<16x16xbf16>) attrs =  {prov.region_id = "softmax_0", prov.family = "normalization", prov._pattern_hint = "softmax", prov.op = "softmax", prov.aten = "aten._softmax.default", prov.orig_dtype = "bfloat16"} {
    ^bb3(%44: bf16, %45: bf16, %46: bf16):
      %47 = arith.divf %44, %45 : bf16
      linalg.yield %47 : bf16
    } -> tensor<16x16xbf16>
    %48 = tensor.empty() : tensor<16x32xbf16>
    %49 = arith.constant 0.000000e+00 : bf16
    %50 = linalg.fill {prov.op = "fill", prov.family = "fill"} ins(%49 : bf16) outs(%48 : tensor<16x32xbf16>) -> tensor<16x32xbf16>
    %51 = linalg.matmul {prov.region_id = "matmul_1", prov.op = "matmul", prov.family = "contraction", prov.aten = "aten.mm.default", prov.orig_dtype = "bfloat16"} ins(%43, %2 : tensor<16x16xbf16>, tensor<16x32xbf16>) outs(%50 : tensor<16x32xbf16>) -> tensor<16x32xbf16>
    func.return %51 : tensor<16x32xbf16>
  }
}
