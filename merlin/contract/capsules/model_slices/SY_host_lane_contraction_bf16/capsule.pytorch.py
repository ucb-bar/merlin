"""Auto-generated capsule loader (depthwise_conv2d, bf16). Defines the op in PyTorch; model2MLIR
...
class Model(nn.Module):
    def forward(self, x, w):
        return torch.nn.functional.conv2d(x, w, stride=1, padding=2 // 2, groups=1)
def get_model_and_inputs():
    return Model(), (_r(1, 1, 8, 8), _r(1, 1, 2, 2))
