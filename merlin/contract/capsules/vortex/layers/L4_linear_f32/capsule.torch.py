"""L4_linear_f32 — torch source for the capsule (authored for model2MLIR).

linear (f32). Lowering this through model2MLIR's FXImporter backend yields standard-dialect
