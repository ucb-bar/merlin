"""V9_data_dependent_select_f32 — torch source for the capsule (authored for model2MLIR).

data-dependent select: y = a>0 ? 2a : -a. Lowering this through model2MLIR's FXImporter backend yields standard-dialect
