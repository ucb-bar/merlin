"""V14_elementwise_add_i32 — torch source for the capsule (authored for model2MLIR).

elementwise add (i32). Lowering this through model2MLIR's FXImporter backend yields standard-dialect
...
def get_model_and_inputs():
    torch.manual_seed(0)
    a = torch.randint(-5, 5, (8, 8,), dtype=torch.int32)
    b = torch.randint(-5, 5, (8, 8,), dtype=torch.int32)
