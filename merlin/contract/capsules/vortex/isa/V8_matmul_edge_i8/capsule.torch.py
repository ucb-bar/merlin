"""V8_matmul_edge_i8 — torch source for the capsule (authored for model2MLIR).

matmul (i8 x i8 -> i32). Lowering this through model2MLIR's FXImporter backend yields standard-dialect
...
def get_model_and_inputs():
    torch.manual_seed(0)
    a = torch.randint(-8, 8, (5, 13,), dtype=torch.int8)
    w = torch.randint(-8, 8, (13, 7,), dtype=torch.int8)
