"""V1_elementwise_add_i8 — torch source for the capsule (authored for model2MLIR).

elementwise add (i8 -> i32). Lowering this through model2MLIR's FXImporter backend yields standard-dialect
...
def get_model_and_inputs():
    torch.manual_seed(0)
    a = torch.randint(-8, 8, (8, 8,), dtype=torch.int8)
    b = torch.randint(-8, 8, (8, 8,), dtype=torch.int8)
