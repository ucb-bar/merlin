"""V3_matmul_f32 — torch source for the capsule (authored for model2MLIR).

matmul (f32). Lowering this through model2MLIR's FXImporter backend yields standard-dialect
