"""V4_reduce_rows_f32 — torch source for the capsule (authored for model2MLIR).

row-wise sum reduction (f32). Lowering this through model2MLIR's FXImporter backend yields standard-dialect
