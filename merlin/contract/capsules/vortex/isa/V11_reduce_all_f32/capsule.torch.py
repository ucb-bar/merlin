"""V11_reduce_all_f32 — torch source for the capsule (authored for model2MLIR).

whole-tensor sum reduction (f32). Lowering this through model2MLIR's FXImporter backend yields standard-dialect
