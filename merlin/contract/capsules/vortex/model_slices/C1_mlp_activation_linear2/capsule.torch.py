"""C1_mlp_activation_linear2 — torch source for the capsule (authored for model2MLIR).

linear (i8 x i8 -> i32) + relu. Lowering this through model2MLIR's FXImporter backend yields standard-dialect
...
class Capsule(nn.Module):
    def forward(self, a, w):
        _mm = torch.matmul(a.to(torch.int32), w.to(torch.int32))
