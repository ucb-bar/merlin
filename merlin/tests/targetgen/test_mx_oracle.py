...
def _load_generate_corpus():
    from merlin_experiments.phase0 import numerics

    return numerics


@pytest.mark.parametrize("tok,dims", [("mxfp8", (16, 32, 16)), ("mxfp4", (32, 32, 32)), ("mxfp6", (16, 32, 16))])
def test_generated_mx_capsule_grades_bit_exact(tok, dims):
    ...
    res = mx_oracle.grade_matmul(prov["operand_codes"], prov["SA_e8m0_codes"], prov["SB_e8m0_codes"], golden["Y0"])
