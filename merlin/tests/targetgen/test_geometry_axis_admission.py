...
def _synthesize(required: list[dict], **extra) -> dict:
    ...
    return CS.synthesize(
        _minimal_spec(required, **extra), workload_spec={"models": [], "precision_preference": ["int8"]}
    )
        ...
        [
            {
                ...
                "out_elements": 49152,
                "n_regions": 289,
                "mac_fraction": 0.094393,
            }
        ],
        cert_affordability={"max_elements": 875, "budget_s": 300.0, "metric": "written_output_elements"},
        oracle_tiers=["L2", "L3"],
    )
