...
# RATCHET, and it has shrunk: the two `SY_host_lane_*` rows were regenerated by the host-lane axis and
# now declare `must_accelerate: False` alongside their forbid, so they no longer contradict themselves.
_PREDATES_THE_FIX = {
