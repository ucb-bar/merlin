...
from merlin.targetgen.oracle_policy import OracleTierPlan, register_sim_oracle
...
register_sim_oracle(
    ...
    exclusive=True,
    # _adapters returns the literal empty map: no fallible construction changes keys.
    tier_plan=lambda target: OracleTierPlan((), requirements_inference_safe=True),
)
