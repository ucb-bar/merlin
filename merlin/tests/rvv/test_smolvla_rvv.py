...
REPO = repo_root()
PREFIX = REPO / "out/artifacts/recaptures/smolvla_prefix_consistent"
FULL = REPO / "out/artifacts/recaptures/smolvla_int8_consistent"
...
def test_smolvla_prefix_exact(tmp_path):
    ...
    res = run_model(PREFIX, tmp_path, cache_dir=REPO / "out/artifacts/cache/kc_smolvla_prefix")
