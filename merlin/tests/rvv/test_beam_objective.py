...
def test_rank_results_inert_sorts_last_on_a_tie():
    nodes = [
        {"run_id": "inert", "gate_ok": True, "speedup": 1.0, "structural_match": 0.9, "inert": True},
        {"run_id": "live", "gate_ok": True, "speedup": 1.0, "structural_match": 0.9, "inert": False},
    ]
...
def test_rank_results_uses_ranked_speedup_when_present():
    ...
    nodes = [
        {"run_id": "clamped", "gate_ok": True, "speedup": 1.9, "ranked_speedup": 1.0, "structural_match": 0.5},
        {"run_id": "real_win", "gate_ok": True, "speedup": 1.4, "ranked_speedup": 1.4, "structural_match": 0.5},
    ]
...
def test_inert_forks_are_excluded_from_survivors(tmp_path):
    ...
    def mock_certify(*, package_dir, model_dir, runs_root, run_id, targets, baseline_run_dir):
        ...
        return {
            "correctness": {"gate_ok": True},
            "measurement": [{"target": "k1", "wall_ns": 500}],
        }  # a "faster" (noise) wall
...
def _explore_certify(*, package_dir, model_dir, runs_root, run_id, targets, baseline_run_dir):
    ...
    return {"correctness": {"gate_ok": True}, "measurement": [{"target": "k1", "wall_ns": wall}], "divergences": _DIVS}
