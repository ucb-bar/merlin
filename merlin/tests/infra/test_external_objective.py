...
def corpus(tmp_path, monkeypatch):
    ...
    result = PAS.FrozenPerformanceCorpus(
...
def test_multiple_external_models_receive_distinct_readonly_grants(tmp_path, monkeypatch):
    ...
    inputs = PAS.build_answer_free_agent_inputs(frozen, target, tmp_path / "inputs", external_objectives=objectives)
    sentinels = [PAS.select_external_e2e_sentinel(objective, inputs) for objective in objectives]
