...
def test_generator_records_a_template_path_that_resolves_from_repo_root():
    ...
    template = _generator().load_profile(declaration.profile, **declaration.profile_inputs())["_performance_template"]
...
def test_generator_records_every_family_the_template_declares():
    ...
    declaration = for_target("gemmini")
    template = generator.load_profile(declaration.profile, **declaration.profile_inputs())["_performance_template"]
