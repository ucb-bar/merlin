...
from merlin_experiments.phase2.claims import affine as AF
from merlin_experiments.phase2.claims import dispatch as D
...
def _descriptor(analyzer, family="PM"):
    return {
        "name": "PM00_m16n16",
        "inputs": [],
        "performance": {"family": family, "claim": "PREDICTS", "acceptance": {"analyzer": analyzer}},
    }
