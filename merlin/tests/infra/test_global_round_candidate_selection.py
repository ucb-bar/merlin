...
COST = PortfolioAnalysis.authored_host_cost
BEST = PortfolioAnalysis.best_authored_candidate
...
class _Stub:
    ...
    def __init__(self, iterations):
        self.session = SimpleNamespace(journal=SimpleNamespace(iterations=iterations))
