...
# --------------------------------------------------------------------------- nobody else gets it
@pytest.mark.parametrize("stem", ["raw_baseline", "merlin_assisted", "merlin_assisted_rtlchecks", "cpp_merlininfra"])
...
def test_adding_the_variant_did_not_make_the_plain_merlin_arm_ambiguous(monkeypatch, tmp_path):
    ...
    assert P.RAE.ARM_BUNDLE["merlin_assisted"] == "merlin_assisted_public_v0"  # absent here
