...
def _fake_repo(tmp_path, *, source: dict, packaged: dict, setup_src: str = _SETUP, bundle: bool = True):
...
class TestTheGateCanFail:
    ...
    def test_a_stale_answer_key_in_the_bundle_is_reported(self, tmp_path):
        ...
        root = _fake_repo(
            tmp_path,
            source={"contract/capsules/x/capsule.yaml": "a: 1\n"},
