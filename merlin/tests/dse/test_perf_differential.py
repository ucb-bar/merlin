...
from merlin.perf.differential import EXACT, ORDERING_ONLY, REFUSED, comparable, compare, rank_schedules
...
def test_a_non_additive_operator_gives_an_ordering_but_not_a_magnitude() -> None:
    ...
    d = {"vpu": _D(64)}
    out = compare(
        _c(1000, unresolved=("vpu",), operator=Composition.MAX),
...
def test_a_pairwise_overlap_operator_is_refused_not_approximated() -> None:
    d = {"vpu": _D(64)}
    out = compare(
        _c(1000, unresolved=("vpu",), operator=Composition.PARTIAL, eta=0.5),
...
def test_schedules_composed_by_different_rules_are_not_comparable() -> None:
    d = {"vpu": _D(64)}
    ok, why = comparable(
        _c(1000, unresolved=("vpu",), operator=Composition.SUM),
        _c(1400, unresolved=("vpu",), operator=Composition.MAX),
        demands_a=d,
        demands_b=d,
    )
...
def test_equal_resolved_parts_are_a_tie_not_a_winner() -> None:
    d = {"vpu": _D(64)}
    out = compare(_c(1000, unresolved=("vpu",)), _c(1000, unresolved=("vpu",)), demands_a=d, demands_b=d)
...
def test_ranking_retains_the_pairs_it_could_not_compare() -> None:
    ...
    cands = {"x": _c(1000, unresolved=("vpu",)), "y": _c(1200, unresolved=("vpu",)), "z": _c(900, unresolved=("xlu",))}
...
def test_the_claim_never_states_a_magnitude_it_cannot_support() -> None:
    ...
    exact = compare(_c(1000, unresolved=("vpu",)), _c(1400, unresolved=("vpu",)), demands_a=d, demands_b=d)
