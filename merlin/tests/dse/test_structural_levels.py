...
def _clean():
    ...
    return _buffer(
        {"opcode": STAGE, "operands": {"src": "W", "dst": "W_res"}, "attributes": {"layout": "packed_rhs"}},
...
def test_an_unfused_single_consumer_fires():
    ...
    report = SL.findings(
        _buffer(
            {"opcode": "MATMUL", "operands": {"lhs": "A0", "rhs": "W", "dst": "t0"}, "attributes": {"epilogue": []}},
...
def _generator_levels() -> frozenset:
    return PROFILES._PERFORMANCE_LEVELS
