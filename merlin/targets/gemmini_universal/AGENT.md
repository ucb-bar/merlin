...
The authored target contract and ABI now live in `examples/gemmini_universal/target/`.
This legacy directory retains compatibility links and historical generated-output
scaffolding, not a second source owner.
