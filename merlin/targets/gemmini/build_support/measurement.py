...
def assemble_measurement_fragments(
    warmup_work: str, *, requested: str = "warm", include: str = "", prologue: str = "", epilogue: str = ""
) -> dict:
    ...
    return {
        ...
        "warmup": warmup,
        "cache_state": "unknown",
        "cache_state_observed": False,
        "cache_protocol": ("one_unmeasured_predecessor" if requested == "warm" else "fresh_elf_process"),
