...
- workload class: **flow_matching_action_head**  ·  K=5, H=5, control_rate=30.0 Hz
...
- **attributed IR facts (Level-1)**: `{'matmul_count': 17, 'macs_per_invocation': 1114798080, 'weight_bytes': 169086976, 'activation_bytes_per_invocation': 6053888, 'invocations': 5, 'macs_total': 5573990400, 'activation_bytes_total': 30269440}`
...
- **evidence**: `{'backbone_phases': ['backbone'], 'head_phases': ['head'], 'K': 5, 'H': 5, 'control_rate_hz': 30.0, 'replan_deadline_ms': 166.66666666666666}`
...
- **evidence**: `{'H': 5, 'control_rate_hz': 30.0, 'replan_deadline_ms': 166.66666666666666}`
