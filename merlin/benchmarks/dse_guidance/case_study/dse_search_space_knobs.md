...
| intra_op_sharding | P7 | True | shard_axis in {M,N,K}, shard_count in [2, 4, 8] | 96 reduction-free M/N shards available; K-sharding needs partial-sum reduction |
| inter_op_parallelism | P7 | False | num_engines | avg inter-op parallelism 1.27x (low -> limited; favors intra-op sharding) |
