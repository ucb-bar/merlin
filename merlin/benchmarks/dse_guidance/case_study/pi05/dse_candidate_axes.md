# Structural DSE candidate axes — pi05

- workload class: **flow_matching_action_head**  ·  K=10, H=50, control_rate=50.0 Hz
...
- **attributed IR facts (Level-1)**: `{'matmul_count': 288, 'macs_per_invocation': 1828521639936, 'weight_bytes': 9210953728, 'activation_bytes_per_invocation': 4587868672, 'invocations': 10, 'macs_total': 18285216399360, 'activation_bytes_total': 45878686720}`
...
- **evidence**: `{'backbone_phases': ['backbone'], 'head_phases': ['head'], 'K': 10, 'H': 50, 'control_rate_hz': 50.0, 'replan_deadline_ms': 1000.0}`
...
- **evidence**: `{'H': 50, 'control_rate_hz': 50.0, 'replan_deadline_ms': 1000.0}`
