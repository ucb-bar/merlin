# Structural DSE candidate axes — smolvla

- workload class: **flow_matching_action_head**  ·  K=10, H=50, control_rate=30.0 Hz
...
- **attributed IR facts (Level-1)**: `{'matmul_count': 116, 'macs_per_invocation': 5094387200, 'weight_bytes': 206126080, 'activation_bytes_per_invocation': 25975680, 'invocations': 10, 'macs_total': 50943872000, 'activation_bytes_total': 259756800}`
...
- **evidence**: `{'backbone_phases': ['backbone'], 'head_phases': ['head'], 'K': 10, 'H': 50, 'control_rate_hz': 30.0, 'replan_deadline_ms': 1666.6666666666667}`
...
- **evidence**: `{'H': 50, 'control_rate_hz': 30.0, 'replan_deadline_ms': 1666.6666666666667}`
