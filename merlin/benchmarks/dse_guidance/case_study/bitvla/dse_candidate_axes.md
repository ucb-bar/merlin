# Structural DSE candidate axes — bitvla

- workload class: **autoregressive_decode**  ·  K=7, H=7, control_rate=5.0 Hz
...
- **attributed IR facts (Level-1)**: `{'matmul_count': 15, 'macs_per_invocation': 46137344, 'weight_bytes': 5767168, 'activation_bytes_per_invocation': 1212416, 'invocations': 7, 'macs_total': 322961408, 'activation_bytes_total': 8486912}`
...
- **evidence**: `{'backbone_phases': ['backbone'], 'head_phases': ['head'], 'K': 7, 'H': 7, 'control_rate_hz': 5.0, 'replan_deadline_ms': 1400.0}`
...
- **evidence**: `{'H': 7, 'control_rate_hz': 5.0, 'replan_deadline_ms': 1400.0}`
