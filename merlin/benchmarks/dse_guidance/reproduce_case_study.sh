...
OUT="${1:-merlin/benchmarks/dse_guidance/case_study_regen}"
...
"$PY" -m pytest merlin/python/tests/test_dse_guidance.py -q

echo "done. Compare against the committed reference:"
echo "  diff -r merlin/benchmarks/dse_guidance/case_study ${OUT}"
