builtin.module attributes {prov.weights_file = "/scratch/agustin/projects/model2MLIR/workloads/groot_n1d7/groot_n1d7.safetensors", prov.level = "linalg-on-tensors"} {
