# AGENT.md — merlin/compiler/include/merlin/Conversion

## Purpose

Headers for cross-dialect conversions/lowerings (scaffold).
...
- Stable C++ plane: no experimental Python here; scaffold only for now.
