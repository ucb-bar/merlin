...
module attributes {stream.affinity.default = #hal.device.affinity<@device_a>} {
  ...
  util.func public @schedule(%arg0: !hal.buffer_view, %arg1: !hal.fence, %arg2: !hal.fence) -> (!hal.buffer_view, !hal.buffer_view, !hal.buffer_view) attributes {iree.abi.stub, iree.reflection = {iree.abi.declaration = "async func @schedule(%input0: tensor<128x128xf32> {iree.abi.affinity = #hal.device.promise<@device_a>}) -> (%output0: tensor<128x128xf32> {iree.abi.affinity = #hal.device.promise<@device_a>}, %output1: tensor<128x128xf32> {iree.abi.affinity = #hal.device.promise<@device_a>}, %output2: tensor<128x128xf32> {iree.abi.affinity = #hal.device.promise<@device_a>})", iree.abi.model = "coarse-fences"}} {
    ...
    %2 = flow.dispatch @schedule_dispatch_0::@schedule_dispatch_0_pack_f32(%1) : (tensor<128x128xf32>) -> tensor<16x128x8x1xf32>
    %3 = flow.dispatch @schedule_dispatch_1::@schedule_dispatch_1_pack_f32(%1) : (tensor<128x128xf32>) -> tensor<32x128x4x1xf32>
    %4 = flow.dispatch @schedule_dispatch_2::@schedule_dispatch_2_mmt4d_16x32x128x8x4x1_f32(%2, %3) : (tensor<16x128x8x1xf32>, tensor<32x128x4x1xf32>) -> tensor<16x32x8x4xf32>
    %5 = flow.dispatch @schedule_dispatch_3::@schedule_dispatch_3_unpack_f32(%4) : (tensor<16x32x8x4xf32>) -> tensor<128x128xf32>
    ...
    %8 = flow.dispatch @schedule_dispatch_4::@schedule_dispatch_4_elementwise_16384_f32(%7) : (tensor<16384xf32>) -> tensor<16384xf32>
    %9 = flow.tensor.transfer %5 : tensor<128x128xf32> to #hal.device.affinity<@device_ab>
    %10 = flow.tensor.reshape %9 : tensor<128x128xf32> -> tensor<16384xf32>
    %11 = flow.dispatch @schedule_dispatch_5::@schedule_dispatch_5_elementwise_16384_f32(%10) : (tensor<16384xf32>) -> tensor<16384xf32>
    %12 = flow.tensor.transfer %11 : tensor<16384xf32> to #hal.device.affinity<@device_a>
    %13 = flow.dispatch @schedule_dispatch_6::@schedule_dispatch_6_elementwise_16384_f32(%12) : (tensor<16384xf32>) -> tensor<16384xf32>
    %14 = flow.tensor.reshape %13 : tensor<16384xf32> -> tensor<128x128xf32>
    %15 = flow.dispatch @schedule_dispatch_7::@schedule_dispatch_7_elementwise_16384_f32(%7) : (tensor<16384xf32>) -> tensor<16384xf32>
    %16 = flow.tensor.transfer %8 : tensor<16384xf32> to #hal.device.affinity<@device_ab>
    %17 = flow.dispatch @schedule_dispatch_8::@schedule_dispatch_8_elementwise_16384_f32(%16) : (tensor<16384xf32>) -> tensor<16384xf32>
