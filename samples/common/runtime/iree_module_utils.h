/** @file iree_module_utils.h
 *  @brief Heuristic entry-function picker for IREE VMFB modules.
 */

#ifndef MERLIN_RUNTIME_IREE_MODULE_UTILS_H_
#define MERLIN_RUNTIME_IREE_MODULE_UTILS_H_
...
/** @brief Select the best entry function from a compiled VMFB module.
 *
 *  Preference order:
 *    1. If there is exactly one exported function, use it.
 *    2. Otherwise, prefer an export whose first argument is i32.
 *    3. Fall back to export ordinal 0.
 *
 *  @param module        The loaded VM module to inspect.
 *  @param[out] out_fn          Resolved entry function handle.
 *  @param[out] out_arity       Number of input arguments (0 or 1).
 *  @param[out] out_first_is_i32 true if the first argument is i32.
 *  @return OK on success, or NOT_FOUND if the module has no exports.
 */
...
#endif // MERLIN_RUNTIME_IREE_MODULE_UTILS_H_
