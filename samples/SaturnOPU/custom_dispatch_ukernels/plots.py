...
plt.plot(x_labels, ours_ops, color="#0033cc", linewidth=3, marker="o", markersize=8, label="Ours (RVV + OPU)")
...
# Create Green Bars
bars = plt.bar(baseline_x_subset, speedup_factors, color="#00b050", edgecolor="black", width=0.6, zorder=3)
