...
#executable_target_embedded_elf_riscv_64 = #hal.executable.target<"llvm-cpu", "embedded-elf-riscv_64", {cpu = "generic-rv64", cpu_features = "+m,+a,+f,+d,+v,+zvl512b,+zvbb", data_layout = "e-m:e-p:64:64-i64:64-i128:128-n32:64-S128", iree.encoding.resolver = #iree_cpu.cpu_encoding_resolver<>, max_stack_allocation_size = 32768 : i64, native_vector_size = 128 : i64, target_abi = "lp64d", target_triple = "riscv64-unknown-unknown-eabi-elf"}>
...
module attributes {transform.with_named_sequence} {
  ...
  hal.executable private @executable {
    hal.executable.variant public @executable_target_embedded_elf_riscv_64 target(#executable_target_embedded_elf_riscv_64) objects([
  ...
  util.func private @call_mul_abs_negate(%arg0: tensor<?xf32>, %arg1: tensor<?xf32>) -> tensor<?xf32> {
    ...
    %0 = flow.dispatch @executable::@executable_target_embedded_elf_riscv_64::@simple_mul_abs_negate[%dim](%dim_i32, %arg0, %arg1) : (i32, tensor<?xf32>{%dim}, tensor<?xf32>{%dim}) -> tensor<?xf32>{%dim}

    util.return %0 : tensor<?xf32>
  }

  //%13 = linalg.generic {indexing_maps = [#map1, #map2, #map1], iterator_types = ["parallel", "parallel"]} ins(%12, %2 : tensor<1x128xf32>, tensor<128xf32>) outs(%11 : tensor<1x128xf32>) {
  //  ^bb0(%in: f32, %in_15: f32, %out: f32):
  //    %44 = arith.addf %in, %in_15 : f32
  //    linalg.yield %44 : f32
  //  } -> tensor<1x128xf32>
