...
void i8_mm_scalar(int32_t *c_bias, int32_t *c_out, int8_t *at, int8_t *b,
...
void i8_loop_k_general(
	int8_t *at, int8_t *b, size_t M, size_t N, size_t K, size_t ml, size_t vl) {
	for (size_t k = 0; k < K; k++) {
...
void i8_1x2_loop_k(
	int8_t *at, int8_t *b, size_t ml, size_t M, size_t N, size_t K) {
	asm volatile("vsetvli zero, %0, e8, m1, ta, ma" : : "r"(ml));
