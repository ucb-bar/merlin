# Radiance: Phase 0 — hardware-guided test generation

Start with [the experiment definition](../experiment.yaml), catalog ID
`radiance-functional`, runtime target `radiance`.
...
```sh
merlin experiment inspect radiance-functional --phase 0
merlin experiment preflight radiance-functional --phase 0
merlin experiment run radiance-functional --phase 0 --run-dir /configured/out/runs/radiance/phase0/example-1
merlin experiment corpus prepare /configured/out/runs/radiance/phase0/example-1 --output /configured/out/artifacts/protocols/radiance-review-1
merlin experiment corpus inspect /configured/out/artifacts/protocols/radiance-review-1
```
...
```sh
merlin experiment corpus seal /configured/out/artifacts/protocols/radiance-review-1 \
