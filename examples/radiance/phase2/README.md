...
schemas. Neither is a ready-to-run Radiance performance experiment.

Copy a template into an authored input directory, keep `kind: template` until
every declared input and budget is supplied, and set `target: radiance`.
