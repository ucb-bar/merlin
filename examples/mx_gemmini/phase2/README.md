...
schemas. Neither is a ready-to-run MX Gemmini performance experiment.

Copy a template into an authored input directory, keep `kind: template` until
every declared input and budget is supplied, and set `target: mx_gemmini`.
