...
colors = [COLORS["merlin"] if row["category"] != "contraction" else COLORS["executorch"] for row in rows]
bars = ax.barh(y, [row["ms"] for row in rows], color=colors, edgecolor="black", linewidth=0.45)
