...
RETIRED = [
    ("merlin/compiler", "pb", "wb", "retired tree merlin/compiler/ (see docs/design/compiler_plane.md)"),
    ("merlin/integrations", "pb", "wb", "retired tree merlin/integrations/ (see docs/design/integrations.md)"),
