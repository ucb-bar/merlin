...
specs under ``experiments/reference-data/phase0/conformance/``, which is the same source
...
from merlin.targetgen.corpora import conformance_reference_dir  # noqa: E402
...
CONFORMANCE_DIR = conformance_reference_dir()
